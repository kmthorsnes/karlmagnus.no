...
import {
  useRouter,
  useRouterState
} from "./chunk-UL3SIRNW.js";
import "./chunk-472FLE3U.js";
import "./chunk-P3HS7KVR.js";
import "./chunk-JCLDUJEF.js";
import "./chunk-JC6BUL45.js";
import {
  require_jsx_runtime
...
// node_modules/.pnpm/@tanstack+react-router-devtools@1.131.2_@tanstack+react-router@1.131.2_react-dom@19.1.1_d1dcbe5de9fd51872dc4923567a1e079/node_modules/@tanstack/react-router-devtools/dist/esm/TanStackRouterDevtools.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);

// node_modules/.pnpm/@tanstack+router-devtools-core@1.131.2_@tanstack+router-core@1.131.2_csstype@3.1.3_solid-js@1.9.8_tiny-invariant@1.3.3/node_modules/@tanstack/router-devtools-core/dist/esm/TanStackRouterDevtoolsCore.js
var __typeError = (msg) => {
  throw TypeError(msg);
};
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-IMS572OK.js"));
...
// node_modules/.pnpm/@tanstack+router-devtools-core@1.131.2_@tanstack+router-core@1.131.2_csstype@3.1.3_solid-js@1.9.8_tiny-invariant@1.3.3/node_modules/@tanstack/router-devtools-core/dist/esm/TanStackRouterDevtoolsPanelCore.js
...
var TanStackRouterDevtoolsPanelCore = class {
  constructor(config) {
    ...
    __privateAdd2(this, _style);
    __privateAdd2(this, _className);
    ...
    __privateSet2(this, _style, createSignal(style));
    __privateSet2(this, _className, createSignal(className));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      const [style] = __privateGet2(this, _style);
      const [className] = __privateGet2(this, _className);
      ...
      if (__privateGet2(this, _Component2)) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-EYO6HZBZ.js"));
  ...
  setStyle(style) {
    __privateGet2(this, _style)[1](style);
  }
  setClassName(className) {
    __privateGet2(this, _className)[1](className);
  }
  setOptions(options) {
    if (options.shadowDOMTarget !== void 0) {
...
_className = /* @__PURE__ */ new WeakMap();
...
// node_modules/.pnpm/@tanstack+react-router-devtools@1.131.2_@tanstack+react-router@1.131.2_react-dom@19.1.1_d1dcbe5de9fd51872dc4923567a1e079/node_modules/@tanstack/react-router-devtools/dist/esm/TanStackRouterDevtoolsPanel.js
...
// node_modules/.pnpm/@tanstack+react-router-devtools@1.131.2_@tanstack+react-router@1.131.2_react-dom@19.1.1_d1dcbe5de9fd51872dc4923567a1e079/node_modules/@tanstack/react-router-devtools/dist/esm/index.js
